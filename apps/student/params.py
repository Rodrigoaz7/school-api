...
def getSwaggerParams():
    listParams = [
        ...
        openapi.Parameter('registration', openapi.IN_QUERY, type=openapi.TYPE_STRING),
...
def getFiltersRequest(params):
    queryset = {}
    basicFilters = ['name', 'email', 'registration', 'quant_by_page', 'page']
    fieldsStringContain = ['name', 'email']
    fieldsBoolean = []
    fieldsForeignKeys = []
